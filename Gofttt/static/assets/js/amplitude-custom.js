Amplitude.init({
  "songs": [{
    "name": "گفت‌کست انقلابی ۰۱",
    "artist": "تیموتی کی. آگیلار",
    "album": "Business Podcast",
    "url": STATIC_URL + "assets/images/01.mp3",
    "cover_art_url": STATIC_URL + "assets/images/01.jpg",
    "id": "d1",
  }, {
    "name": "گفت‌کست انقلابی ۰۲",
    "artist": "دونا سی نیکولز",
    "album": "Education Podcast",
    "url": STATIC_URL + "assets/images/01.mp3",
    "cover_art_url": STATIC_URL + "assets/images/02.jpg",
    "id": "d2",
  }, {
    ...
    "url": STATIC_URL + "assets/images/01.mp3",
    "cover_art_url": STATIC_URL + "assets/images/03.jpg",
    "id": "d3",
  }, ],
});
...
var songsToAdd = [{
  ...
  "album": "Business",
  "url": STATIC_URL + "assets/images/01.mp3",
  "cover_art_url": STATIC_URL + "assets/images/04.jpg",
  "id": "n4",
}, {
  ...
  "album": "Self Growth",
  "url": STATIC_URL + "assets/images/01.mp3",
  "cover_art_url": STATIC_URL + "assets/images/show/05.jpg",
  "id": "n5",
}, {
  ...
  "album": "Comedy",
  "url": STATIC_URL + "assets/images/01.mp3",
  "cover_art_url": STATIC_URL + "assets/images/06.jpg",
  "id": "n6",
}, {
  ...
  "album": "Music",
  "url": STATIC_URL + "assets/images/01.mp3",
  "cover_art_url": STATIC_URL + "assets/images/07.jpg",
  "id": "n7",
}, {
  ...
  "album": "Education",
  "url": STATIC_URL + "assets/images/01.mp3",
  "cover_art_url": STATIC_URL + "assets/images/08.jpg",
  "id": "n8",
}, {
  "name": "Mindset In Our Life Ep:1",
  "artist": "Linda Clarke",
  ...
  "album": "Life Story",
  "url": STATIC_URL + "assets/images/01.mp3",
  "cover_art_url": STATIC_URL + "assets/images/05.jpg",
  "id": "n13",
}, {
